define(function(require, exports, module) {
    ...
    MenuBarView.prototype.animateIcon = function() {	// filterIcon animation

        var paramOptions =  {duration: this.options.duration, curve: 'easeInOut'};

        if(this.SelectImageViewSelected) {
    ...
    function _createMenu() {
        ...
        //filter icon
        this.SelectImageViewSelected = false;
    ...
    function _setListeners() {
        ...
        this.xIconSurf.on('click', function() {
            if(this.SelectImageViewSelected) { //display list view & filter-icon
                this.SelectImageViewSelected = false;
                this.animateIcon();
            } else { //display filter view & x-icon
                this.SelectImageViewSelected = true;
                this.animateIcon();
            }
            this._eventOutput.emit('SelectImageViewToggle');	// event to trim the actin on AppView
        }.bind(this));
    }
